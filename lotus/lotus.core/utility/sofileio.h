 ...
 */
SOGL_API_ENTRY ubyte sogl_is_file(const char* path);
 ...
 */
SOGL_API_ENTRY char* sogl_read_file(const char* path);
 ...
 */
SOGL_API_ENTRY ubyte sogl_delete_file(const char* path);
 ...
 */
SOGL_API_ENTRY long sogl_get_file_size(const char* path);
 ...
 * @return 1 on success, 0 on failure.
 */
SOGL_API_ENTRY ubyte sogl_copy_file(const char* dest, const char* src);
 ...
 * @return 1 on success, 0 on failure.
 */
SOGL_API_ENTRY ubyte sogl_append_file(const char* data, const char* path, ubyte newline);
 ...
 * @return 1 on success, 0 on failure.
 */
SOGL_API_ENTRY ubyte sogl_write_file(const char* data, const char* path, ubyte preserve);
 ...
 * @return 1 on success, 0 on failure.
 */
SOGL_API_ENTRY ubyte sogl_process_file(void (*processLine)(const char* line), const char* path);
