...
unsigned char lotus_register_component(
...
unsigned char lotus_unregister_component(lotus_component_manager* manager, lotus_component_type type) {
...
unsigned char lotus_has_component(lotus_component_manager* manager, lotus_component_type type, lotus_entity entity) {
