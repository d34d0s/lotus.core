...
#include "mesh/lotus_mesh.h"
#include "texture/lotus_texture.h"
...
typedef struct lotus_component_manager {
    ...
    struct component_register {
        void* data;
        unsigned char active[LOTUS_ENTITY_MAX];
    } component_register[LOTUS_COMPONENT_TYPES];
} lotus_component_manager;

LOTUS_API_ENTRY unsigned char lotus_register_component(
...
LOTUS_API_ENTRY unsigned char lotus_unregister_component(lotus_component_manager* manager, lotus_component_type type);

LOTUS_API_ENTRY void lotus_add_component(lotus_component_manager* manager, lotus_component_type type, lotus_entity entity);
LOTUS_API_ENTRY unsigned char lotus_has_component(lotus_component_manager* manager, lotus_component_type type, lotus_entity entity);
