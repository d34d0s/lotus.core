...
char vShader[] = {
    "#version 460 core\n"
    "layout(location = 0) in vec3 u_Location;\n"
    ...
    "void main() {\n"
    "   gl_Position = u_projection * u_view * u_model * vec4(u_Location, 1.0f);\n"
...
int main() {
    ...
    lotus_renderer_init();
    lotus_renderer_begin(LOTUS_TRIANGLE_MODE, 133, 161, 172, 255, lotus_ortho(0, 1, 0, 1, 0.1, 1000));
